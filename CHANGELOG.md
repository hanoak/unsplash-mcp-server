...
- 097c48d: Add an `mcpName` field to `package.json` so the package can be listed on the official MCP Registry (registry.modelcontextprotocol.io). No runtime or API changes.
